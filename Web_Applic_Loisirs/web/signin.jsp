<%-- 
    Document   : SignIn
    Created on : 24 nov. 2020, 20:08:27
    Author     : Simon
--%>
	...
	<div class="container-login100" style="background-image: url('images/background.jpg');">
			...
			Le site des loisirs près de chez vous                                          
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
                        <input class="input100" type="text" name="username" value="<%=request.getParameter("username") %>" readonly>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password again">
                        <input class="input100" type="text" name="repass" placeholder="Confirmed password">
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>

                    <div class="container-login100-form-btn p-b-34">
                        <button class="login100-form-btn" name="request" value="signin">
                            Sign In
			</button>
                    </div>
